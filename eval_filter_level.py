...
model_save_folder = "filter_models/{}/full_model/{}_{}.pth".format(args.dataset, args.pretraining_type, args.finetuning_type)
weights_save_folder = "filter_models/{}/weights/{}_{}.pth".format(args.dataset, args.pretraining_type, args.finetuning_type)
...
acc=evals.classifier(cc_model, dataset, LogReg(finetuning_args["num_hidden"], num_classes), device, n_epochs = args.cls_epochs)["acc"]
